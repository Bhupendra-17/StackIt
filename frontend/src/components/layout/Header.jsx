    ...
    <header className="sticky top-0 z-50 w-full border-b bg-gray-800 backdrop-blur">
      <div className="container flex h-16 items-center">
        ...
        <a href="/" className="flex items-center space-x-2">
          <img
            src="/Banner.png" // ✅ no import needed from public/
            alt="Logo"
        ...
        <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
          ...
          {/* Navigation Icons */}
          <nav className="flex items-center gap-3 hover:cursor-pointer">
            {/* Ask Question Button */}
            <Link to='/ask'>
              <button className=" hover:cursor-pointer hidden sm:inline-flex bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors">
                Ask Question
              </button>
            </Link>
            {/* 🔔 Notifications */}
